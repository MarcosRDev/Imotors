...
function InfoCar(){
    ...
    useEffect(() => {
        ...
        .then(response => {
            ...
            setAno_fabricacao(response.data[0].anoFabricacao);
            setAno_modelo(response.data[0].anoModelo);
            ...
            setInd_troca(response.data[0].indTroca);
            setUrl_Foto(response.data[0].urlFoto);
        });
    }, [id]);
